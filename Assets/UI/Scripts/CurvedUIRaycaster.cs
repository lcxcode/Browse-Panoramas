...
namespace CurvedUI
{
    public class CurvedUIRaycaster : GraphicRaycaster
    {
        ...
        ClientData clientData = new ClientData();   // Add By Lcx
        ...
        public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
        {
            ...
            ray3D = new Ray(handle.position, handle.transform.forward);
            ...
            //{
            //    handle.GetComponent<HandleControl>().btnTrans = eventData.pointerEnter.transform.parent;
            //    handle.GetComponent<HandleControl>().eventData = eventData;
            //}

            //if(SceneManage.Instance.selectedBtn)
            //{
            //    EventSystem.current.SetSelectedGameObject(SceneManage.Instance.selectedBtn);
            //}
            //---------------------------------------------------------------------------------------------------------------------------------------------------------------------
